  ...
  useEffect(() => {
    ...
    const loadBlockedDates = async () => {
      try {
        ...
        const blocked = getFullyBookedDateStrings(
          rangeStart,
          rangeEnd,
          rescheduleTarget.duration_minutes || 60,
          booked || [],
        )
        setRescheduleBlockedDates(blocked)
      } catch {
        setRescheduleBlockedDates(new Set())
      }
    }
    ...
    try {
      ...
      toast({
        ...
        description: proceedWithCase
          ? "The lawyer can request case completion when work is done. You'll confirm from the Case page."
